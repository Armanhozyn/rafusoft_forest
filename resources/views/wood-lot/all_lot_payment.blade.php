...
<a href="{{ route('lot_payment') }}" class="btn btn-sm btn-neutral">Create New Wood Lot Payment</a>
{{-- @endcan --}}
@endpush
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card mb-5">
            <div class="card-header bg-transparent">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 class="mb-0">All Woodlot Payment</h3>
                    </div>
                </div>
            </div>
            <div class="card-body px-2">
                ...
                <div class="table-responsive">
                    <div>
                        <table id="lotPaymentTable" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Serial No</th>
                                    ...
                                    <th>{{ __('sold_garden.total_amount_collection') }}</th>
                                    <th>Created At</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
...
<script>
    $(document).ready(function() {
        ...
        let table = $('#lotPaymentTable').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            // ajax: `{{ route('lot_payment') }}`,
            ajax: {
                url:`{{ route('all_lot_payment') }}`,
                data: function (data) {
            ...
            columns: [
                ...
                { data: 'total_amount_collection', name: 'total_amount_collection' },
