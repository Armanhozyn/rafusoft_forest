            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('money_collection_date', 'Collection Date', ['class' =>
                                'form-control-label']) }}
                                {{ Form::date('money_collection_date', null, ['class' => 'form-control form-control-sm',
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('money_collection_slip_no', 'Collection Slip No', ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('money_collection_slip_no', null, ['class' => 'form-control
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('collection_amount', 'Collection Amount', ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('collection_amount', null, ['class' => 'form-control form-control-sm',
                                'id' => 'CollectionAmount']) }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('vat', 'Vat Amount', ['class' =>
                                'form-control-label']) }}
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('tax', 'Tax Amount', ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('tax', null, ['class' => 'form-control form-control-sm',
                                'id' => 'Tax']) }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('late_fees', 'Late fees', ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('late_fees', null, ['class' => 'form-control form-control-sm',
                                'id' => 'Late fees']) }}
                            </div>
                        </div>
                    </div>
                ...
                <input type="hidden" name="range_lot_no_year" value="{{$range_lot_year_no}}">
