        ...
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    {!! Form::open(['url' => 'garden/woodlot/bank-deposit', 'files' => false, 'id' => 'entryForm']) !!}
                    <h6 class="heading-small text-muted mb-4">Bank Deposit</h6>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                {{ Form::label('invoice_date', 'চালানের তারিখ', ['class' => 'form-control-label']) }}
                                {{ Form::date('invoice_date', null, ['class' => 'form-control form-control-sm', 'id' => 'InvoiceDate', 'value' => date('Y-m-d')]) }}
                            </div>

                            <div class="form-group">
                                {{ Form::label('invoice_no', 'চালান নং', ['class' => 'form-control-label']) }}
                                {{ Form::text('invoice_no', null, ['class' => 'form-control form-control-sm', 'id' => 'invoiceNo']) }}
                            </div>

                            <div class="form-group">
                                {{ Form::label('forest_revenew', 'বন রাজস্বের পরিমান (টাকা)', ['class' => 'form-control-label']) }}
                                {{ Form::text('forest_revenew', null, ['class' => 'form-control form-control-sm', 'id' => 'forest_revenew']) }}
                            </div>
                        </fieldset>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    {{ Form::label('beneficiary_invoice_date', 'রশিদরে তারিখ', ['class' => 'form-control-label']) }}
                                    {{ Form::date('beneficiary_invoice_date', null, ['class' => 'form-control form-control-sm', 'id' => 'beneficiary_invoice_date', 'value' => date('Y-m-d')]) }}
                                </div>

                                <div class="form-group">
                                    {{ Form::label('beneficiary_invoice_no', 'রশিদ নং', ['class' => 'form-control-label']) }}
                                    {{ Form::text('beneficiary_invoice_no', null, ['class' => 'form-control form-control-sm', 'id' => 'beneficiary_invoice_no']) }}
                                </div>

                                <div class="form-group">
                                    {{ Form::label('beneficiary_share_amount', 'উপকারভোগীর অংশের পরিমান (টাকা)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('beneficiary_share_amount', null, ['class' => 'form-control form-control-sm', 'id' => 'beneficiary_share_amount']) }}
                                </div>
