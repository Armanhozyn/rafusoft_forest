            ...
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        <img src="https://forest.dinajpur.gov.bd/themes/responsive_npf/img/logo.png">
                        <h1 class="text-white">Forest Department, Dinajpur</h1>
            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-secondary border border-soft">
                    <div class="card-header px-lg-5 bg-transparent">
                        <h3 class="text-mutedx text-center my-2">Sign In</h3>
