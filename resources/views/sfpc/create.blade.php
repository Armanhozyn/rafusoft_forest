                    ...
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="name" class="form-control-label">{{trans('navbar.sfpc')}} {{trans('lang.name')}}</label>
                                    <input class="form-control" name="name" value="{{old('name')}}" type="text" id="name">
                                </div>
                                <div class="form-group">
                                    <label for="name_in_english" class="form-control-label">{{trans('navbar.sfpc')}} {{trans('lang.name_in_english')}}</label>
