...
<style>
     fieldset {
    border: 1px solid #ced4da; /* Set the desired border style */
    border-radius: 4px; /* Optionally, add border-radius for rounded corners */
    padding: 10px; /* Optional padding to create spacing between the border and contents */
     margin-bottom: 20px;
        ...
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    {!! Form::open(['url' => 'garden/profit-share', 'files' => false, 'id' => 'entryForm']) !!}
                    <h6 class="heading-small text-muted mb-4">Profit Distribution</h6>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                <legend>উপকারভোগী</legend>


    
                                <div class="form-group">
                                    {{ Form::label('beneficiary_male', 'উপকারভোগীর সংখ্যা (পুরুষ)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('beneficiary_male', null, ['class' => 'form-control form-control-sm', 'id' => 'forest_revenew']) }}
                                </div>
    
                                <div class="form-group">
                                    {{ Form::label('beneficiary_female', 'উপকারভোগীর সংখ্যা (মহিলা)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('beneficiary_female', null, ['class' => 'form-control form-control-sm', 'id' => 'forest_revenew']) }}
                                </div>



                                <div class="form-group">
                                    {{ Form::label('beneficiary_profit_share', 'উপকারভোগীর অংশের পরিমান (টাকা)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('beneficiary_profit_share', null, ['class' => 'form-control form-control-sm', 'id' => 'beneficiary_share_amount']) }}
                                </div>
                            ...
                            <fieldset>
                                <legend>ভূমি মালিক</legend>
        
                                <div class="form-group">
                                    {{ Form::label('land_owner_profit_share', 'ভূমি মালিকের  অংশের পরিমান (টাকা)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('land_owner_profit_share', null, ['class' => 'form-control form-control-sm', 'id' => 'land_owner_profit_share']) }}
                                </div>
                            </fieldset>

                            <fieldset>
                                <legend>ইউনিয়ন পরিষদ</legend>
        
                                <div class="form-group">
                                    {{ Form::label('union_parishadh_profit_share', 'ইউনিয়ন পরিষদ এর অংশের পরিমান (টাকা)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('union_parishadh_profit_share', null, ['class' => 'form-control form-control-sm', 'id' => 'union_parishadh_profit_share']) }}
                                </div>
                            </fieldset>
                              ...
                              <fieldset>
                                ...
                                <div class="form-group">
                                    {{ Form::label('tff_profit_share', 'টিএফএফ এর অংশের পরিমান (টাকা)', ['class' => 'form-control-label']) }}
                                    {{ Form::text('tff_profit_share', null, ['class' => 'form-control form-control-sm', 'id' => 'tff_profit_share']) }}
                                </div>
                            </fieldset>
