                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-general">
                            <ul class="nav nav-sm flex-column">
                                @can('view-user')
                                <li class="nav-item">
                                    <a href="{{url('/country')}}" class="nav-link"><span class="sidenav-mini-icon">D
                                        </span><span class="sidenav-normal">{{ __('navbar.countries') }}</span></a>
                                </li>
                                @endcan

                                @can('create-country_division')
                                <li class="nav-item">
                                    <a href="{{url('/country_division')}}" class="nav-link"><span
                                            class="sidenav-mini-icon">D
                                ...
                                @can('view-user')
                                <li class="nav-item">
                                    <a href="{{url('/district')}}" class="nav-link"><span class="sidenav-mini-icon">D
                                        </span><span class="sidenav-normal">{{ __('navbar.districts') }}</span></a>
                                </li>
                                @endcan

                                @can('view-user')
                                <li class="nav-item">
                                    <a href="{{url('/thana')}}" class="nav-link"><span class="sidenav-mini-icon">D
                                        </span><span class="sidenav-normal">{{ __('lang.thana') }}</span></a>
                                </li>
                                @endcan
                                ...
                                @can('view-user')
                                <li class="nav-item">
                                    <a href="{{url('/range')}}" class="nav-link"><span class="sidenav-mini-icon">D
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link {{ request()->is('garden*') ? 'active' : '' }}" href="#navbar-garden-info"
                            ...
                            aria-controls="navbar-garden-info">
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('garden-information.index') }}" class="nav-link"><span
                                            class="sidenav-mini-icon">D </span><span class="sidenav-normal">বাগানের
                                            তালিকা</span></a>
                                </li>
                                @endcan
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('garden.create') }}" class="nav-link"><span
                                            class="sidenav-mini-icon">D </span><span class="sidenav-normal">{{__('নতুন
                                            বাগান সৃজনের তথ্য')}}</span></a>
                                </li>
                                @endcan
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('garden*') ? 'active' : '' }}" href="#navbar-sold-garden"
                            data-toggle="collapse" role="button" aria-expanded="true"
                            aria-controls="navbar-sold-garden">
                            <i class="fas text-primary fa-list-alt"></i>
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('garden.bikrito')}}" class="nav-link"><span
                                            class="sidenav-mini-icon"></span><span class="sidenav-normal">{{
                                            __('sold_garden.sold_garden_totto') }}
                                        </span></a>
                                </li>
                                @endcan
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('lot_payment') }}" class="nav-link"><span
                                            class="sidenav-mini-icon"></span><span class="sidenav-normal">{{
                                            __('navbar.lot_money_collection_and_deposit') }}</span></a>
                                </li>
                                @endcan

                                @can('create-category')
                                    <li class="nav-item">
                                        <a href="{{ route('woodlot.deposite') }}" class="nav-link"><span
                                                class="sidenav-mini-icon"></span><span class="sidenav-normal">{{
                                                __('navbar.woodlot_deposite') }}</span></a>
                                    </li>
                                @endcan
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('garden.woodlot.bank_deposit') }}" class="nav-link"><span
                                            class="sidenav-mini-icon"></span><span class="sidenav-normal">{{
                                            __('navbar.bank_deposit_details') }}</span></a>
                                </li>
                                @endcan
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('paymenthistory.index') }}" class="nav-link"><span
                                            ...
                                            __('navbar.payment_history') }}</span></a>
                                </li>
                                @endcan --}}
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('garden*') ? 'active' : '' }}" href="#navbar-profit-share"
                            data-toggle="collapse" role="button" aria-expanded="true"
                            aria-controls="navbar-profit-share">
                            <i class="fas text-primary fa-list-alt"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('category*') ? 'active' : '' }}" href="#navbar-report"
                            data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-report">
                            <i class="fas text-primary fa-list-alt"></i>
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('/report/index')}}" class="nav-link"><span
                                            class="sidenav-mini-icon">D </span><span class="sidenav-normal">প্রতিবেদন
                                            তৈরি করুন</span></a>
                                </li>
                                @endcan
