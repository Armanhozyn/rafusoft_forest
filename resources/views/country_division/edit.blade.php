@extends('layouts.app')
@push('pg_btn')
<a href="{{route('country_division.index')}}" class="btn btn-sm btn-neutral">All Country_division</a>
@endpush
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card mb-5">
            <div class="card-body">
                ...
                @endcan
                <h6 class="heading-small text-muted mb-4">Country_division information</h6>
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
