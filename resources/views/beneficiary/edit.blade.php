@extends('layouts.app')
@push('pg_btn')
<a href="{{route('beneficiary.index')}}" class="btn btn-sm btn-neutral">সব সুবিধাভোগী</a>
@endpush
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card mb-5">
            <div class="card-body">
                ...
                @endcan
                <h6 class="heading-small text-muted mb-4">সুবিধাভোগী</h6>
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select id="garden_id" name="garden_id" class="form-control form-control-sm">
                                    ...
                                    <option {{$garden->id == $beneficiary->garden_id ? 'selected' : ''}} value="{{
                                        $garden->id }}">{{ $garden->id }}
                                    </option>
                                    @endforeach
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select id="voter_id" name="voter_id" class="form-control form-control-sm">
                                    ...
                                    <option {{#form->id == $beneficiary ->range_id ? 'selected' : ''}} value="{{
                                        #form->range_id }}">{{ #form->name }}
                                    </option>
                                    @endforeach
