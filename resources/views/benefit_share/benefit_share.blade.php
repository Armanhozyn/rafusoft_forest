...
<a href="{{ route('benefit.share.list') }}" class="btn btn-sm btn-neutral">All Benefit Share</a>
{{-- @endcan --}}
@endpush
@section('content')
<div class="row">
                        ...
                        <table id="gardenBikritoTable" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('garden.lot_count') }}</th>
                                    <th>{{ __('garden.total_sell') }}</th>
                                    <th>Created At</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
