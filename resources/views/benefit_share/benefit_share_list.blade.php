    ...
    <div class="col-md-12">
        <div class="card mb-5">
            <div class="card-header bg-transparent">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 class="mb-0">All Benefit Share Payment List</h3>
                    </div>
                </div>
            </div>
                        ...
                        <table id="gardenBikritoTable" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('garden.office_order_no') }}</th>
                                    <th>প্রতিষ্ঠান/সংস্থা/সদস্য</th>
                                    <th>টাকার পরিমাণ লিখুন</th>
                                    <th>Created At</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
    ...
    $(document).ready(function() {
        ...
        let table = $('#gardenBikritoTable').DataTable({
            ...
            columns: [
                ...
                { data: 'office_order_no', name: 'office_order_no' },
                { data: 'institutes', name: 'institutes' },
