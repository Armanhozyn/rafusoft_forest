@extends('layouts.app')
@push('pg_btn')
<a href="{{ route('lot_payment') }}" class="btn btn-sm btn-neutral">Pyments</a>
@endpush
@section('content')
    ...
    <div class="col-md-12">
        <div class="card mb-5">
            <div class="card-body">
                ...
                {!! Form::open(['url' => route('garden.sell.store'), 'files' => false, 'id' => 'entryForm']) !!}
                <h6 class="heading-small text-muted mb-4">Sell Bagan</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('bikrito_bagan_shon', __('garden.creation_year'), ['class' => 'form-control-label']) }}
                                {{ Form::select('bikrito_bagan_shon', $yearPairs, null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Select garden year...']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('dorpotro_biggopti_no', __('sold_garden.dorpotro_biggopti_no'), ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('dorpotro_biggopti_no', null, ['class' => 'form-control
                                form-control-sm', 'id' => 'CollectionSlipNo']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('bikrito_date', __('sold_garden.bikrito_date'), ['class' =>
                                'form-control-label']) }}
                                {{ Form::date('bikrito_date', null, ['class' => 'form-control form-control-sm',
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('total_lot_count', __('sold_garden.total_lot_count'), ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('total_lot_count', null, ['class' => 'form-control form-control-sm',
                                'id' => 'total_lot_count']) }}
                            </div>
                        </div>
                    </div>
