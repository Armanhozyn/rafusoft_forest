@extends('layouts.app')
@push('pg_btn')
<a href="{{ route('tff') }}" class="btn btn-sm btn-neutral">Make Tff Payment</a>
@endpush
@section('content')
<div class="row" id="app">
    <div class="col-md-12">
        <div class="card mb-5">
            <div class="card-body">
                {!! Form::open(['route' => 'tff.store', 'files' => false, 'id' => 'garden-create-form']) !!}
                ...
                <div class="pl-lg-4 mb-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                {{ Form::label('tff_payment', trans('garden.tff_payment'), ['class' =>
                                'form-control-label']) }}
                                {{ Form::text('tff_payment', null, ['class' => 'form-control form-control-sm',
                                'id' => 'tff_payment', 'value' => old('tff_payment')]) }}
                            </div>
                        </div>
                    </div>
                </div>
