@extends('layouts.app')
@push('pg_btn')
    <a href="{{ route('country.index') }}" class="btn btn-sm btn-neutral">সৃজিত বাগানের তালিকা</a>
@endpush
@section('content')
        ...
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    <h6 class="heading-small text-muted mb-4">সৃজিত বাগানের চুক্তিনামা দাখিল</h6>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            {{-- {{ dd($roles) }} --}}
                            {{ Form::label('garden_creation_id', __('বাগান সৃজনের তালিকা'), ['class' => 'form-control-label']) }}
                            {{ Form::select('garden_creation_id', $gardenCreations, null, ['class' => 'form-control form-control-sm', 'placeholder' => __('একটি বাগান সৃজন নির্বাচন করুন'), 'id' => 'garden-creation-id']) }}
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">ইতিহাস</div>
                            <div class="card-body">
                              <p><strong>প্রকল্প/খাত:</strong> ... </p>
                              <p><strong>বাগানের ধরন:</strong> ... </p>
                              <p><strong>বাগান সৃজনের সন:</strong> ... </p>
                              <p><strong>আবর্ত:</strong> ... </p>
                              <p><strong>সৃজিত বাগানের পরিমাণ:</strong> ... </p>
                              <p><strong>বাগানের অবস্থান:</strong> </p>
                              <p>জেলা: ... </p>
                              <p>উপজেলা: ... </p>
                              <p>ইউনিয়ন: ... </p>
                              <p>মৌজা: ... </p>
...
$('#garden-creation-id').on('click', function(){
            let value = $(this).val();
